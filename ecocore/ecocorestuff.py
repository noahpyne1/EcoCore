...
from ecocore import window
from ecocore import mouse
from ecocore import camera
from ecocore import raycaster
from ecocore.raycaster import raycast, boxcast
from ecocore import color
from ecocore.input_handler import held_keys
...
def import_all_classes(path=application.asset_folder, debug=False):
    ...
    from ecocore.string_utilities import snake_to_camel
