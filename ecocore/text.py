...
class Text(Entity):
    ...
    def create_background(self, padding=size*2, radius=size, color=ecocore.color.black66):
        from ecocore import Quad, destroy
    ...
    def appear(self, speed=.025, delay=0):
        from ecocore.ecocorestuff import invoke
        self.enabled = True
