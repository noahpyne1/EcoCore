...
from ecocore.ecocoremath import lerp
from ecocore import curve
from ecocore.curve import CubicBezier
from ecocore.mesh_importer import load_model
from ecocore.texture_importer import load_texture
from ecocore.string_utilities import camel_to_snake
from textwrap import dedent

from ecocore import color
try:
    from ecocore import scene
except:
    pass
...
class Entity(NodePath):
    ...
    def __init__(self, add_to_scene_entities=True, **kwargs):
        ...
        if application.trace_entity_definition and add_to_scene_entities:
            ...
            if caller.code_context:
                ...
                and not 'Ecocore()' in self.code_context):
    ...
    def combine(self, analyze=False, auto_destroy=True):
        from ecocore.scripts.combine import combine
